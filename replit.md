...
## Overview
「おしかけログ」は、横浜F・マリノスのサポーター向けに特化した観戦記録Webアプリケーションです。ユーザーは観戦した公式試合の記録、それに伴う交通費、チケット代、飲食費などの費用を詳細に追跡できます。本サービスは、観戦記録から得られる勝敗、費用合計、平均費用などの統計データをユーザーに提供し、観戦体験の振り返りと費用管理をサポートすることを目的としています。
